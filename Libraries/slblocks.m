...
%
blkStruct.Name = ['Simscape Scissor Lift Library'];
%
% The function that will be called when the user double-clicks on
% this icon.
%
blkStruct.OpenFcn = 'sm_scissor_lift_lib';
...
%
blkStruct.MaskDisplay = 'Simscape Scissor Lift Library';
...
Browser(1).Library = 'sm_scissor_lift_lib';
Browser(1).Name    = 'Simscape Scissor Lift Library';
